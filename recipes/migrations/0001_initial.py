    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructions', djrichtextfield.models.RichTextField(max_length=15000)),
                ...
                ('cuisine_types', models.CharField(choices=[('african', 'African'), ('south_american', 'South American'), ('asian', 'Asian'), ('middle_eastern', 'Middle Eastern'), ('indian', 'Indian'), ('european', 'European'), ('mediterranean', 'Mediterranean')], default='african', max_length=60)),
